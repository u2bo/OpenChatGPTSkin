...
> [!NOTE]
> 这些图片仅用于视觉概念与能力展示，不是内置主题、不随安装包提供，也不代表与相关人物、作品或权利人的官方合作。公开使用或再分发前，请自行确认肖像、角色、商标和素材授权。
...
| 能力 | 状态 |
|---|---|
| Theme Schema v3、`.ocskin` 校验/打包/解包 | 已完成 |
| 四个原创内置主题 | 已完成 |
...
packages/theme-schema/      Theme Schema v3 与视觉模型
