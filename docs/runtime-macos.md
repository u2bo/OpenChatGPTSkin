...
3. 依次执行 `launch`、七个 `switch`，检查八个内置主题在首页、历史、任务、设置、插件、菜单、弹层、输入框、侧边栏和终端中一致。
...
8. 记录 Codex 版本、macOS 版本、八主题结果、恢复结果和脱敏截图；不要记录 PID、端口、用户名、路径、命令行、项目名或聊天内容。
