...
export function compileTheme(bundle: ValidatedThemeBundle): CompiledTheme {
  ...
  const themeCss = [
    ...
    `color:inherit!important;border-color:var(--ocs-border)!important;}`,
    `${overlaySurface} :where(button,[role=button]){color:var(--ocs-text)!important;`,
    `background:transparent!important;border-color:var(--ocs-border)!important;box-shadow:none!important;}`,
    `${overlaySurface} :where(button,[role=button]):is([class*="bg-token-foreground"],`,
    `[class*="bg-token-text-link-foreground"]){color:var(--ocs-panel)!important;`,
    `background-color:var(--ocs-accent)!important;border-color:var(--ocs-accent)!important;}`,
    ...
    `${composerSurface} :is(.composer-surface-chrome,[class*="bg-token-main-surface"],`,
    `[class*="bg-token-input-background"],[class*="bg-token-bg-fog"],`,
    `[class*="bg-token-dropdown-background"]):not(`,
